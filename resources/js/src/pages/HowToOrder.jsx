        ...
        <div className="min-h-screen bg-cream py-20 px-6 2xl:px-20">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="text-center mb-16">
                    <h1 className="text-5xl md:text-7xl font-bold text-dark2 mb-4">
                        How It Works
                    </h1>
                ...
                <section className="mb-20">
                    ...
                    <div className="grid md:grid-cols-4 gap-8">
                        {[
                            ...
                            {
                                icon: (
                                    <FaShoppingCart className="text-5xl text-green-700" />
                                ),
                            ...
                            {
                                icon: (
                                    <FaTruck className="text-5xl text-green-700" />
                                ),
                                title: "We Make & Ship",
                            ...
                            <div key={i} className="text-center group">
                                <div className="relative mb-8">
                                    <div className="w-28 h-28 mx-auto rounded-full bg-green-100 flex items-center justify-center  transition-all duration-300 shadow-xl">
                                        {step.icon}
                                    </div>
                                </div>
                ...
                {/* Order Tracking */}
                <section className="mb-20 bg-green-50 rounded-3xl p-10 md:p-16">
                    <div className="flex items-start gap-8 max-w-4xl mx-auto">
                        <div className="w-20 h-20 bg-green-700 rounded-full flex-shrink-0 flex items-center justify-center shadow-xl">
                        ...
                        <div>
                            ...
                            <p className="text-lg text-gray-700 leading-relaxed">
                                ...
                                anytime to see real-time delivery updates and
                                know exactly when your comfort is arriving.
                            </p>
                        </div>
                    </div>
                </section>
                ...
                <section className="bg-white rounded-3xl shadow-2xl p-10 md:p-16">
                    <div className="flex items-start gap-8 max-w-4xl mx-auto">
                        <div className="w-20 h-20 bg-emerald-100 rounded-full flex-shrink-0 flex items-center justify-center shadow-xl">
                            <FaRulerCombined className="text-4xl text-green-700" />
                        </div>
                        <div>
                            <h2 className="text-4xl font-bold text-dark2 mb-6">
                                Size Guide
                            ...
                            <a
                                href="/size-guide"
                                className="inline-block mt-6 bg-green-700 text-cream px-8 py-4 rounded-full font-semibold hover:bg-green-800 transition shadow-lg"
                            >
                ...
                <div className="text-center mt-20">
                    ...
                    <a
                        href="/shop"
                        className="inline-block bg-green-700 text-cream px-12 py-5 rounded-full text-xl font-semibold hover:bg-green-800 transition shadow-2xl transform hover:scale-105"
                    >
                        Start Shopping Now
                    </a>
                </div>
