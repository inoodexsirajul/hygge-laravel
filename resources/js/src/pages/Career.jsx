...
const Career = () => {
    ...
    const handleVideoChange = (e) => {
        ...
        if (
            ...
            setError("video_cv", { message: "Only MP4, AVI, MOV, WMV, FLV, WebM, MPEG allowed" });
            setUploadedVideo(null);
            e.target.value = "";
            return;
        }
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="mb-6">
                            <label className="block text-sm font-medium text-gray-200 mb-3">
                                Video CV / Introduction <span className="text-red-400">*</span>
                            </label>
                            {!uploadedVideo ? (
                                <label
                                    htmlFor="video_cv"
                        ...
                        <div className="mb-6">
                            ...
                            />
                            {errors.coverLetter && (
                                <p className="mt-2 text-sm text-red-400">{errors.coverLetter.message}</p>
                            )}
                        </div>

                        <button
                            type="submit"
                            disabled={isLoading || !uploadedFile || !uploadedVideo} // Video ও required
